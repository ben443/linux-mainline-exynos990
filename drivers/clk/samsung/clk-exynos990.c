...
static const struct samsung_mux_clock top_mux_clks[] __initconst = {
	...
	MUX(CLK_MOUT_CLKCMU_MCSC_GDC, "mout_clkcmu_mcsc_gdc",
...
static const struct samsung_gate_clock hsi0_gate_clks[] __initconst = {
	GATE(CLK_GOUT_DP_LINK_IPCLKPORT_I_DP_GTC_CLK,
	     "gout_hsi0_dp_link_ipclkport_i_dp_gtc_clk",
	     "mout_hsi0_dpgtc_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_DP_LINK_IPCLKPORT_I_DP_GTC_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_DP_LINK_IPCLKPORT_I_PCLK,
	     "gout_hsi0_dp_link_ipclkport_i_pclk",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_DP_LINK_IPCLKPORT_I_PCLK,
	     21, 0, 0),     
	GATE(CLK_GOUT_D_TZPC_HSI0_IPCLKPORT_PCLK,
	     "gout_hsi0_d_tzpc_ipclkport_pclk",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_D_TZPC_HSI0_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_LHM_AXI_P_HSI0_IPCLKPORT_I_CLK,
	     "gout_hsi0_lhm_axi_p_ipclkport_i_clk",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_LHM_AXI_P_HSI0_IPCLKPORT_I_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_PPMU_HSI0_BUS1_IPCLKPORT_ACLK,
	     "gout_hsi0_ppmu_bus1_ipclkport_aclk",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_PPMU_HSI0_BUS1_IPCLKPORT_ACLK,
	     21, 0, 0),
	GATE(CLK_GOUT_PPMU_HSI0_BUS1_IPCLKPORT_PCLK,
	     "gout_hsi0_ppmu_bus1_ipclkport_pclk",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_PPMU_HSI0_BUS1_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_RSTNSYNC_CLK_HSI0_BUS_IPCLKPORT_CLK,
	     "gout_hsi0_rstnsync_ipclkport_clk",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_RSTNSYNC_CLK_HSI0_BUS_IPCLKPORT_CLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_SYSMMU_USB_IPCLKPORT_CLK_S2,
	     "gout_hsi0_sysmmu_usb_ipclkport_clk_s2",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_SYSMMU_USB_IPCLKPORT_CLK_S2,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_SYSREG_HSI0_IPCLKPORT_PCLK,
	     "gout_hsi0_sysreg_ipclkport_pclk",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_SYSREG_HSI0_IPCLKPORT_PCLK,
	     21, 0, 0),
	GATE(CLK_GOUT_USB31DRD_IPCLKPORT_ACLK_PHYCTRL, 
	     "gout_hsi0_usb31drd_ipclkport_aclk_phyctrl", 
	     "mout_hsi0_bus_user", 
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_ACLK_PHYCTRL, 
	     21, 0, 0),
	GATE(CLK_GOUT_USB31DRD_IPCLKPORT_BUS_CLK_EARLY, 
	...
	GATE(CLK_GOUT_USB31DRD_IPCLKPORT_I_USBDPPHY_REF_SOC_PLL,
	     ...
	     21, 0, 0),
	     /*
	GATE(CLK_GOUT_USB31DRD_IPCLKPORT_I_USBDPPHY_SCL_APB_PCLK,
	     "gout_hsi0_usb31drd_ipclkport_i_usbdpphy_scl_apb_pclk",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USBDPPHY_SCL_APB_PCLK,
	     21, 0, 0),
	
	GATE(CLK_GOUT_USB31DRD_IPCLKPORT_I_USBPCS_APB_CLK,
	     "gout_hsi0_usb31drd_ipclkport_i_usbpcs_apb_clk",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USBPCS_APB_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_VGEN_LITE_HSI0_IPCLKPORT_CLK,
	     "gout_hsi0_vgen_lite_ipclkport_clk",
	     "mout_hsi0_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI0_UID_VGEN_LITE_HSI0_IPCLKPORT_CLK,
	     21, 0, 0),
	GATE(CLK_GOUT_XIU_D_HSI0_IPCLKPORT_ACLK,
...
static const struct samsung_gate_clock hsi1_gate_clks[] __initconst = {
	...
	GATE(3, "gout_hsi1_blk_hsi1_uid_ufs_embd_ipclkport_i_unipro",
	     ...
	     21, 0, 0),
	GATE(4, "gout_hsi1_sysreg", "mout_hsi1_bus_user", CLK_CON_GAT_GOUT_BLK_HSI1_UID_SYSREG_HSI1_IPCLKPORT_PCLK, 21, 0, 0)
};
...
static const struct samsung_mux_clock hsi1_mux_clks[] __initconst = {
	...
	MUX(1, "mout_hsi1_ufs_embd_user", mout_hsi1_ufs_embd_user_p,
	    PLL_CON0_MUX_CLKCMU_HSI1_UFS_EMBD_USER, 4, 1),
};
